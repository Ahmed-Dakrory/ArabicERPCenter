...
public class moneyboxBean implements Serializable{
	...
	public void selectMoneybox(int moneyboxId) {
		...
		try {
			FacesContext.getCurrentInstance()
			   .getExternalContext().redirect("/pages/ar/secured/admin/controlUsers/moneybox/moneyboxDetails.jsf");
		} catch (IOException e) {
	...
	public void goToAddNewMoneybox() {
		...
		try {
			FacesContext.getCurrentInstance()
			   .getExternalContext().redirect("/pages/ar/secured/admin/controlUsers/moneybox/addMoneybox.jsf");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void updateMoneyBox() {
		...
		try {
			FacesContext.getCurrentInstance()
			   .getExternalContext().redirect("/pages/ar/secured/admin/controlUsers/moneybox/moneybox.jsf");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
