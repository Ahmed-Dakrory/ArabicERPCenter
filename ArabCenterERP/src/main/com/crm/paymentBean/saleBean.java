...
public class saleBean implements Serializable{
	...
	public void selectPayments(int saleId) {
		...
		try {
			FacesContext.getCurrentInstance()
			   .getExternalContext().redirect("/pages/ar/secured/admin/payment/paymentDetails.jsf");
		} catch (IOException e) {
	...
	public void selectSalaPayment(int salePaymentId) {
		...
		try {
			FacesContext.getCurrentInstance()
			   .getExternalContext().redirect("/pages/ar/secured/admin/payment/salePaymentDetails.jsf");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void goToAddNewSale() {
		...
		try {
			FacesContext.getCurrentInstance()
			   .getExternalContext().redirect("/pages/ar/secured/admin/payment/addPayment.jsf");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void addNewSale() {
		...
		try {
			FacesContext.getCurrentInstance()
			   .getExternalContext().redirect("/pages/ar/secured/admin/payment/payments.jsf");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
